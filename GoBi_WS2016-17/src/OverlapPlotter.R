...
plot(same, sameVal, type = "o", xlim = c(0, maxX), ylim = c(0, maxY+1), pch = 0, col = "red", main=biotype, xlab = "#overlapping genes", ylab = "#genes with x overlapping genes(cumulative)")
lines(diff, diffVal, col = "blue", pch = 1, type = "o")
lines(disregard, disregardVal, col = "black", pch = 2, type = "o")
legend("topright", c("sameStrand", "differentStrand", "disregardingStrand"), lty=c(1,1,1), pch = c(0,1,2), col = c("red","blue","black"), inset = c(-0.55, 0))
