...
//		String tempChrID, tempGeneID, tempTranscriptID, tempExonID, tempCDSID, tempBiotype;
//
...
//					currentTranscript = new Transcript(Integer.parseInt(start), Integer.parseInt(end), tempTranscriptID,
...
//				}
//
//				currentExon = new Exon(Integer.parseInt(start), Integer.parseInt(end), tempExonID, strand.equals("-"));
...
//				currentCDSPart = new CDSPart(Integer.parseInt(start), Integer.parseInt(end), tempCDSID,
//						strand.equals("-"));
//
//				break;
//			}
...
//	}
//
//	private Transcript createDummyTranscript(String transID, Gene currentGene) {
...
//		Gene retGene = new Gene(-1, -1, geneID, false, null, null, currentChromosome);
...
//	}
//
//	// schwachsinn! return map.get(key) macht dasselbe, da brauchts die methode
//	// nicht
